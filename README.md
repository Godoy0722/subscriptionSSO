...
- Redirect URL
- Hours valid
- Enable purchase of individual articles or issues in OJS (off by default)
...
With individual purchase turned on, that redirect stops. Readers can buy an article or an issue in OJS, and subscribers sign in from a link placed first in the sidebar on the pages where that content is shown.
